...
蜂鸟巢无文字插图候选 01 已入库。
蜂鸟巢正式卡面主号为 N-007 / DN-D1。
蜂鸟巢当前版本管理完整号为 N-007_DN-D1_CN-v1.0。
下一步进入中文版样卡 v1 合成准备。
```
...
5. 每次导出样卡都必须记录正式卡面主号、版本管理完整号、封存卡号、节点位址、系统域标签、语言版本、样卡版本、插图版本和卡框版本。
```
